...
export default function Footer() {
    ...
    return (
        <footer className="relative px-6 md:px-16 lg:px-24 xl:px-32 mt-40 w-full dark:text-slate-50">
            <img className="absolute max-w-4xl w-full h-auto -mt-30 max-md:px-4 right-0 md:right-16 lg:right-24 xl:right-32 top-0 pointer-events-none" src={theme === "dark" ? "/assets/landing-text-dark.svg" : "/assets/landing-text-light.svg"} alt="landing" width={930} height={340} />
            <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-200 dark:border-slate-700 pb-6">
                <div className="md:max-w-114">
                    ...
                    <p className="mt-6">
                       Generate professional product imagery and commercial videos faster with our AI platform built for speed, flexibility, and growth.
                    </p>
                </div>
                <div className="flex-1 flex items-start md:justify-end gap-20">
                    ...
                    <div>
                        ...
                        <div className="space-y-2">
                            <p>+1-212-456-7890</p>
                            <p>ugcai@example.com</p>
                        </div>
                    </div>
                </div>
            </div>
            <p className="pt-4 text-center pb-5">
                Copyright 2026 © UGC.AI. All Right Reserved.
            </p>
        </footer>
    );
};