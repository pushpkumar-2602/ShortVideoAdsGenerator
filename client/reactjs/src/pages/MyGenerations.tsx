...
const MyGenerations = () => {
  ...
  return loading ?(
    <div className="flex items-center justify-center min-h-screen">
      <Loader2Icon className="w-7 h-7 animate-spin text-indigo-400"/>
    </div>
  ): (
        ...
        <h1 className="text-3xl md:text-4xl font-semibold mb-4">My Generations</h1>
          ...
          {generations.length===0 && (
            <div className="text-center py-20 bg-white/5 rounded-xl border border-white/10">
                <h3 className="text-xl font-medium mb-2">No Generations</h3>
                <p className="text-gray-400 mb-6">Start Creating your product photos today</p>
